...
sed -i -e "s/FNAECSTemplate/${name}" FNAECSTemplate/FNAECSTemplate.csproj
sed -i -e "s/FNAECSTemplate/${name}" FNAECSTemplate.sln
sed -i -e "s/Game1/${name}" FNAECSTemplate/Game1.cs
